...
// it basiclly parse all the information coming from the front-end i.e text and file upload and stores it into the req objects that make accesible at  the backend
const multipart = require('connect-multiparty');
const multipartMiddleware = multipart();

const cloudinary = require('cloudinary');
cloudinary.config({
    cloud_name: 'dhyqiealc',
    api_key: '315237669784456',
    api_secret: 'RYTJHSpKipZZuVXK_zYu3RndUns'
})
...
app.put('/api/users/:id', mongoChecker, authenticateUserProfileOrAdmin, async (req, res) => {
 ...
 // update the  passwords of the users
...
// update the  cloundry images for the particular users->profile pictures
...
// delete any particular user  along with their post ->done by the admin..
...
// to get all the posts present in the databases
