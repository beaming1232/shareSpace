...
const users = [
    {
        ...
        userName: 'shreya sawant ',
        location: 'Western | London',
        review: 'I moved to London from New York, and I can\'t imagine finding the perfect roommate so easily if it wasn\'t for shareSpaces.'  
    },
    {
        userPhoto: userPhoto2,
        userName: 'jaya  ingale',
    ...
    },
    {
        ...
        review: 'Found my roommate and my life partner! These guys are the best! I\'m a working professional, and I move a lot. Thanks shareSpaces. '
    }
]
